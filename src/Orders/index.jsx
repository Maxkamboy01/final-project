...
import { OrderWorks, OrderWork, OrderWork1, OrderWork2, OrderWorkCards, OrderWorkCards1, OrderWorkText, OrderWrapper } from './style'
...
function Orders() {
    ...
    return (
        <OrderWrapper>
            <OrderWork>
                <div>
                    <OrderWorkText>Order <small>15 Orders found</small></OrderWorkText>
                </div>
                <OrderWork1>
